...
export const RESET_PASSWORD_INVALID_LINK_GUIDANCE =
  'Request a new password reset email and use the most recent link.';
export const PASSWORD_RESET_LINK_ERRORS = Object.freeze([
  'Password reset link is invalid',
  'Password reset link has expired'
]);
export const REQUEST_NEW_RESET_LINK_LABEL = 'Request a new reset link';
export const RESET_PASSWORD_SUCCESS_HEADING = 'Password reset complete';
export const RESET_PASSWORD_SUCCESS_GUIDANCE =
  'Your existing sessions have been signed out. Log in with your new password.';
export const CONTINUE_TO_LOGIN_LABEL = 'Continue to login';
